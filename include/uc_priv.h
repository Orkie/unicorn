...
#define UC_MODE_ARM_MASK    (UC_MODE_ARM|UC_MODE_THUMB|UC_MODE_LITTLE_ENDIAN|UC_MODE_MCLASS \
				|UC_MODE_ARM926|UC_MODE_ARM946|UC_MODE_ARM920|UC_MODE_ARM940|UC_MODE_ARM1176|UC_MODE_BIG_ENDIAN)
...
typedef MemoryRegion* (*uc_args_uc_mmio_size_ptr_t)(struct uc_struct*,  hwaddr begin, size_t size, struct mmio_data *data);
...
struct uc_struct {
    ...
    uc_args_uc_mmio_size_ptr_t memory_map_io;
